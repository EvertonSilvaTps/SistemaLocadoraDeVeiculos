...
namespace SistemaLocadoraDeVeiculos
{
    public class Carro : Veiculo  //   | Pilar > Herança
    {
        ...
        public override void ExibirInformacoes()
        {
            ...
            if (this.Cambio == 1)
                Console.WriteLine($"Câmbio: Manual");
            if (this.Cambio == 2)
                Console.WriteLine($"Câmbio: Automático");
        ...
        {                                                        // variávelLista.Add(new Tipo { conteúdo que será adicionado });
            ListaDeCarros.Add(new Carro { Marca = "Fiat",Tipo = "Health", Modelo = "Mobi", Cambio = 1, Cor = "Azul", Placa = "HBJ196" }); 
        ...
        public static void Cadastrar()
        {
            ...
            Console.Write("Tipo [Ex: Hatch, Sedan, SUV]: ");
